...
*   - validation_weight
* @param {string} script_hex
* @param {any[]} script_witness
* @returns {any}
*/
export function run_script(script_hex, script_witness) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(script_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayJsValueToWasm0(script_witness, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.run_script(retptr, ptr0, len0, ptr1, len1);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
