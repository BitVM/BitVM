...
async fn test_take_2_tx() {
    ...
    let secret_nonces_0 = take_2_tx.push_nonces(&verifier_0_context);
    let secret_nonces_1 = take_2_tx.push_nonces(&verifier_1_context);

    take_2_tx.pre_sign(&verifier_0_context, &secret_nonces_0);
