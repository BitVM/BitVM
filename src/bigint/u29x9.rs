...
fn u29_mul_carry_29_imm(u29_constant: u32) -> Script {
    script! {
        ...
        { assert_nn_le(0x1FFFFFFF) } // 0≤A₂₈…₀<2²⁹
        // A₂₈…₀
        if u29_constant >> 0 & 1 == 1 { OP_DUP } else { OP_0 OP_SWAP }
        // A₂₈…₀⋅B₀ A₂₈…₀
        OP_DUP OP_ADD
        // A₂₈…₀⋅B₀ 2¹⋅A₂₈…₀
        { 0x20000000 }
...
pub fn u29x9_mul_karazuba_imm(u29x9_constant: [u32; 9]) -> Script {
    script! {
        ...
        // A₁₊₀ B₁₊₀
        OP_1 OP_PICK OP_1 OP_PICK OP_ADD OP_TOALTSTACK
        // A₂₊₀ B₂₊₀
        OP_2 OP_PICK OP_1 OP_PICK OP_ADD OP_TOALTSTACK
        // A₃₊₀ B₃₊₀
        OP_3 OP_PICK OP_1 OP_PICK OP_ADD OP_TOALTSTACK
        // A₂₊₁ B₂₊₁
        OP_2 OP_PICK OP_2 OP_PICK OP_ADD OP_TOALTSTACK
        // A₄₊₀ B₄₊₀
        OP_4 OP_PICK OP_1 OP_PICK OP_ADD OP_TOALTSTACK
        // A₃₊₁ B₃₊₁
        OP_3 OP_PICK OP_2 OP_PICK OP_ADD OP_TOALTSTACK
        // A₅₊₀ B₅₊₀
        OP_5 OP_PICK OP_1 OP_PICK OP_ADD OP_TOALTSTACK
        // A₄₊₁ B₄₊₁
        OP_4 OP_PICK OP_2 OP_PICK OP_ADD OP_TOALTSTACK
        // A₃₊₂ B₃₊₂
        OP_3 OP_PICK OP_3 OP_PICK OP_ADD OP_TOALTSTACK
        // A₆₊₀ B₆₊₀
        OP_6 OP_PICK OP_1 OP_PICK OP_ADD OP_TOALTSTACK
        // A₅₊₁ B₅₊₁
        OP_5 OP_PICK OP_2 OP_PICK OP_ADD OP_TOALTSTACK
        ...
        OP_4 OP_PICK OP_3 OP_PICK OP_ADD OP_TOALTSTACK
        // A₇₊₀ B₇₊₀
        OP_7 OP_PICK OP_1 OP_PICK OP_ADD OP_TOALTSTACK
        // A₆₊₁ B₆₊₁
        OP_6 OP_PICK OP_2 OP_PICK OP_ADD OP_TOALTSTACK
        // A₅₊₂ B₅₊₂
        OP_5 OP_PICK OP_3 OP_PICK OP_ADD OP_TOALTSTACK
        // A₄₊₃ B₄₊₃
        OP_4 OP_PICK OP_4 OP_PICK OP_ADD OP_TOALTSTACK
        // A₈₊₀ B₈₊₀
        OP_8 OP_PICK OP_1 OP_PICK OP_ADD OP_TOALTSTACK
        // A₇₊₁ B₇₊₁
        OP_7 OP_PICK OP_2 OP_PICK OP_ADD OP_TOALTSTACK
        ...
        OP_5 OP_PICK OP_4 OP_PICK OP_ADD OP_TOALTSTACK
        // A₈₊₁ B₈₊₁
        OP_8 OP_PICK OP_2 OP_PICK OP_ADD OP_TOALTSTACK
        // A₇₊₂ B₇₊₂
        OP_7 OP_PICK OP_3 OP_PICK OP_ADD OP_TOALTSTACK
        // A₆₊₃ B₆₊₃
        OP_6 OP_PICK OP_4 OP_PICK OP_ADD OP_TOALTSTACK
        // A₅₊₄ B₅₊₄
        OP_5 OP_PICK OP_5 OP_PICK OP_ADD OP_TOALTSTACK
        // A₈₊₂ B₈₊₂
        OP_8 OP_PICK OP_3 OP_PICK OP_ADD OP_TOALTSTACK
        // A₇₊₃ B₇₊₃
        OP_7 OP_PICK OP_4 OP_PICK OP_ADD OP_TOALTSTACK
        ...
        OP_6 OP_PICK OP_5 OP_PICK OP_ADD OP_TOALTSTACK
        // A₈₊₃ B₈₊₃
        OP_8 OP_PICK OP_4 OP_PICK OP_ADD OP_TOALTSTACK
        // A₇₊₄ B₇₊₄
        OP_7 OP_PICK OP_5 OP_PICK OP_ADD OP_TOALTSTACK
        // A₆₊₅ B₆₊₅
        OP_6 OP_PICK OP_6 OP_PICK OP_ADD OP_TOALTSTACK
        // A₈₊₄ B₈₊₄
        OP_8 OP_PICK OP_5 OP_PICK OP_ADD OP_TOALTSTACK
        // A₇₊₅ B₇₊₅
        OP_7 OP_PICK OP_6 OP_PICK OP_ADD OP_TOALTSTACK
        // A₈₊₅ B₈₊₅
        OP_8 OP_PICK OP_6 OP_PICK OP_ADD OP_TOALTSTACK
        // A₇₊₆ B₇₊₆
        OP_7 OP_PICK OP_7 OP_PICK OP_ADD OP_TOALTSTACK
        // A₈₊₆ B₈₊₆
        OP_8 OP_PICK OP_7 OP_PICK OP_ADD OP_TOALTSTACK
        // A₈₊₇ B₈₊₇
        OP_8 OP_PICK OP_8 OP_PICK OP_ADD OP_TOALTSTACK
        ...
        // A₈₊₇⋅B₈₊₇ - A₈⋅B₈ - A₇⋅B₇  <=>  A₈⋅B₇ + A₇⋅B₈
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[8] + u29x9_constant[7]) }
        { 18 } OP_PICK { 20 } OP_PICK u29x2_sub_noborrow
        { 16 } OP_PICK { 18 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₈⋅B₇+A₇⋅B₈)₂₈…₀ (A₈⋅B₇+A₇⋅B₈)₅₈…₂₉
        // A₈₊₆⋅B₈₊₆ - A₈⋅B₈ - A₆⋅B₆  <=>  A₈⋅B₆ + A₆⋅B₈
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[8] + u29x9_constant[6]) }
        { 20 } OP_PICK { 22 } OP_PICK u29x2_sub_noborrow
        { 16 } OP_PICK { 18 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₈⋅B₆+A₆⋅B₈)₂₈…₀ (A₈⋅B₆+A₆⋅B₈)₅₈…₂₉
        // A₇₊₆⋅B₇₊₆ - A₇⋅B₇ - A₆⋅B₆  <=>  A₇⋅B₆ + A₆⋅B₇
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[7] + u29x9_constant[6]) }
        { 20 } OP_PICK { 22 } OP_PICK u29x2_sub_noborrow
        { 18 } OP_PICK { 20 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₇⋅B₆+A₆⋅B₇)₂₈…₀ (A₇⋅B₆+A₆⋅B₇)₅₈…₂₉
        // A₈₊₅⋅B₈₊₅ - A₈⋅B₈ - A₅⋅B₅  <=>  A₈⋅B₅ + A₅⋅B₈
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[8] + u29x9_constant[5]) }
        { 24 } OP_PICK { 26 } OP_PICK u29x2_sub_noborrow
        { 18 } OP_PICK { 20 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₈⋅B₅+A₅⋅B₈)₂₈…₀ (A₈⋅B₅+A₅⋅B₈)₅₈…₂₉
        // A₇₊₅⋅B₇₊₅ - A₇⋅B₇ - A₅⋅B₅  <=>  A₇⋅B₅ + A₅⋅B₇
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[7] + u29x9_constant[5]) } // <--
        { 24 } OP_PICK { 26 } OP_PICK u29x2_sub_noborrow
        { 20 } OP_PICK { 22 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₇⋅B₅+A₅⋅B₇)₂₈…₀ (A₇⋅B₅+A₅⋅B₇)₅₈…₂₉
        // A₈₊₄⋅B₈₊₄ - A₈⋅B₈ - A₄⋅B₄  <=>  A₈⋅B₄ + A₄⋅B₈
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[8] + u29x9_constant[4]) } // <--
        { 28 } OP_PICK { 30 } OP_PICK u29x2_sub_noborrow
        { 20 } OP_PICK { 22 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₈⋅B₄+A₄⋅B₈)₂₈…₀ (A₈⋅B₄+A₄⋅B₈)₅₈…₂₉
        // A₆₊₅⋅B₆₊₅ - A₆⋅B₆ - A₅⋅B₅  <=>  A₆⋅B₅ + A₅⋅B₆
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[6] + u29x9_constant[5]) }
        { 26 } OP_PICK { 28 } OP_PICK u29x2_sub_noborrow
        { 24 } OP_PICK { 26 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₆⋅B₅+A₅⋅B₆)₂₈…₀ (A₆⋅B₅+A₅⋅B₆)₅₈…₂₉
        // A₇₊₄⋅B₇₊₄ - A₇⋅B₇ - A₄⋅B₄  <=>  A₇⋅B₄ + A₄⋅B₇
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[7] + u29x9_constant[4]) }
        { 30 } OP_PICK { 32 } OP_PICK u29x2_sub_noborrow
        { 24 } OP_PICK { 26 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₇⋅B₄+A₄⋅B₇)₂₈…₀ (A₇⋅B₄+A₄⋅B₇)₅₈…₂₉
        // A₈₊₃⋅B₈₊₃ - A₈⋅B₈ - A₃⋅B₃  <=>  A₈⋅B₃ + A₃⋅B₈
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[8] + u29x9_constant[3]) }
        { 34 } OP_PICK { 36 } OP_PICK u29x2_sub_noborrow
        { 24 } OP_PICK { 26 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₈⋅B₃+A₃⋅B₈)₂₈…₀ (A₈⋅B₃+A₃⋅B₈)₅₈…₂₉
        // A₆₊₄⋅B₆₊₄ - A₆⋅B₆ - A₄⋅B₄  <=>  A₆⋅B₄ + A₄⋅B₆
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[6] + u29x9_constant[4]) }
        { 32 } OP_PICK { 34 } OP_PICK u29x2_sub_noborrow
        { 28 } OP_PICK { 30 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₆⋅B₄+A₄⋅B₆)₂₈…₀ (A₆⋅B₄+A₄⋅B₆)₅₈…₂₉
        // A₇₊₃⋅B₇₊₃ - A₇⋅B₇ - A₃⋅B₃  <=>  A₇⋅B₃ + A₃⋅B₇
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[7] + u29x9_constant[3]) }
        { 36 } OP_PICK { 38 } OP_PICK u29x2_sub_noborrow
        { 28 } OP_PICK { 30 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₇⋅B₃+A₃⋅B₇)₂₈…₀ (A₇⋅B₃+A₃⋅B₇)₅₈…₂₉
        // A₈₊₂⋅B₈₊₂ - A₈⋅B₈ - A₂⋅B₂  <=>  A₈⋅B₂ + A₂⋅B₈
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[8] + u29x9_constant[2]) }
        { 40 } OP_PICK { 42 } OP_PICK u29x2_sub_noborrow
        { 28 } OP_PICK { 30 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₈⋅B₂+A₂⋅B₈)₂₈…₀ (A₈⋅B₂+A₂⋅B₈)₅₈…₂₉
        // A₅₊₄⋅B₅₊₄ - A₅⋅B₅ - A₄⋅B₄  <=>  A₅⋅B₄ + A₄⋅B₅
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[5] + u29x9_constant[4]) }
        { 36 } OP_PICK { 38 } OP_PICK u29x2_sub_noborrow
        { 34 } OP_PICK { 36 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₅⋅B₄+A₄⋅B₅)₂₈…₀ (A₅⋅B₄+A₄⋅B₅)₅₈…₂₉
        // A₆₊₃⋅B₆₊₃ - A₆⋅B₆ - A₃⋅B₃  <=>  A₆⋅B₃ + A₃⋅B₆
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[6] + u29x9_constant[3]) }
        { 40 } OP_PICK { 42 } OP_PICK u29x2_sub_noborrow
        { 34 } OP_PICK { 36 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₆⋅B₃+A₃⋅B₆)₂₈…₀ (A₆⋅B₃+A₃⋅B₆)₅₈…₂₉
        // A₇₊₂⋅B₇₊₂ - A₇⋅B₇ - A₂⋅B₂  <=>  A₇⋅B₂ + A₂⋅B₇
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[7] + u29x9_constant[2]) }
        { 44 } OP_PICK { 46 } OP_PICK u29x2_sub_noborrow
        { 34 } OP_PICK { 36 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₇⋅B₂+A₂⋅B₇)₂₈…₀ (A₇⋅B₂+A₂⋅B₇)₅₈…₂₉
        // A₈₊₁⋅B₈₊₁ - A₈⋅B₈ - A₁⋅B₁  <=>  A₈⋅B₁ + A₁⋅B₈
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[8] + u29x9_constant[1]) }
        { 48 } OP_PICK { 50 } OP_PICK u29x2_sub_noborrow
        { 34 } OP_PICK { 36 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₈⋅B₁+A₁⋅B₈)₂₈…₀ (A₈⋅B₁+A₁⋅B₈)₅₈…₂₉
        // A₅₊₃⋅B₅₊₃ - A₅⋅B₅ - A₃⋅B₃  <=>  A₅⋅B₃ + A₃⋅B₅
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[5] + u29x9_constant[3]) }
        { 44 } OP_PICK { 46 } OP_PICK u29x2_sub_noborrow
        { 40 } OP_PICK { 42 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₅⋅B₃+A₃⋅B₅)₂₈…₀ (A₅⋅B₃+A₃⋅B₅)₅₈…₂₉
        // A₆₊₂⋅B₆₊₂ - A₆⋅B₆ - A₂⋅B₂  <=>  A₆⋅B₂ + A₂⋅B₆
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[6] + u29x9_constant[2]) }
        { 48 } OP_PICK { 50 } OP_PICK u29x2_sub_noborrow
        { 40 } OP_PICK { 42 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₆⋅B₂+A₂⋅B₆)₂₈…₀ (A₆⋅B₂+A₂⋅B₆)₅₈…₂₉
        // A₇₊₁⋅B₇₊₁ - A₇⋅B₇ - A₁⋅B₁  <=>  A₇⋅B₁ + A₁⋅B₇
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[7] + u29x9_constant[1]) }
        { 52 } OP_PICK { 54 } OP_PICK u29x2_sub_noborrow
        { 40 } OP_PICK { 42 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₇⋅B₁+A₁⋅B₇)₂₈…₀ (A₇⋅B₁+A₁⋅B₇)₅₈…₂₉
        // A₈₊₀⋅B₈₊₀ - A₈⋅B₈ - A₀⋅B₀  <=>  A₈⋅B₀ + A₀⋅B₈
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[8] + u29x9_constant[0]) }
        { 56 } OP_PICK { 58 } OP_PICK u29x2_sub_noborrow
        { 40 } OP_PICK { 42 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₈⋅B₀+A₀⋅B₈)₂₈…₀ (A₈⋅B₀+A₀⋅B₈)₅₈…₂₉
        // A₄₊₃⋅B₄₊₃ - A₄⋅B₄ - A₃⋅B₃  <=>  A₄⋅B₃ + A₃⋅B₄
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[4] + u29x9_constant[3]) }
        { 50 } OP_PICK { 52 } OP_PICK u29x2_sub_noborrow
        { 48 } OP_PICK { 50 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₄⋅B₃+A₃⋅B₄)₂₈…₀ (A₄⋅B₃+A₃⋅B₄)₅₈…₂₉
        // A₅₊₂⋅B₅₊₂ - A₅⋅B₅ - A₂⋅B₂  <=>  A₅⋅B₂ + A₂⋅B₅
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[5] + u29x9_constant[2]) }
        { 54 } OP_PICK { 56 } OP_PICK u29x2_sub_noborrow
        { 48 } OP_PICK { 50 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₅⋅B₂+A₂⋅B₅)₂₈…₀ (A₅⋅B₂+A₂⋅B₅)₅₈…₂₉
        // A₆₊₁⋅B₆₊₁ - A₆⋅B₆ - A₁⋅B₁  <=>  A₆⋅B₁ + A₁⋅B₆
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[6] + u29x9_constant[1]) }
        { 58 } OP_PICK { 60 } OP_PICK u29x2_sub_noborrow
        { 48 } OP_PICK { 50 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₆⋅B₁+A₁⋅B₆)₂₈…₀ (A₆⋅B₁+A₁⋅B₆)₅₈…₂₉
        // A₇₊₀⋅B₇₊₀ - A₇⋅B₇ - A₀⋅B₀  <=>  A₇⋅B₀ + A₀⋅B₇
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[7] + u29x9_constant[0]) }
        { 62 } OP_PICK { 64 } OP_PICK u29x2_sub_noborrow
        { 48 } OP_PICK { 50 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₇⋅B₀+A₀⋅B₇)₂₈…₀ (A₇⋅B₀+A₀⋅B₇)₅₈…₂₉
        // A₄₊₂⋅B₄₊₂ - A₄⋅B₄ - A₂⋅B₂  <=>  A₄⋅B₂ + A₂⋅B₄
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[4] + u29x9_constant[2]) }
        { 58 } OP_PICK { 60 } OP_PICK u29x2_sub_noborrow
        { 54 } OP_PICK { 56 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₄⋅B₂+A₂⋅B₄)₂₈…₀ (A₄⋅B₂+A₂⋅B₄)₅₈…₂₉
        // A₅₊₁⋅B₅₊₁ - A₅⋅B₅ - A₁⋅B₁  <=>  A₅⋅B₁ + A₁⋅B₅
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[5] + u29x9_constant[1]) }
        { 62 } OP_PICK { 64 } OP_PICK u29x2_sub_noborrow
        { 54 } OP_PICK { 56 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₅⋅B₁+A₁⋅B₅)₂₈…₀ (A₅⋅B₁+A₁⋅B₅)₅₈…₂₉
        // A₆₊₀⋅B₆₊₀ - A₆⋅B₆ - A₀⋅B₀  <=>  A₆⋅B₀ + A₀⋅B₆
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[6] + u29x9_constant[0]) }
        { 66 } OP_PICK { 68 } OP_PICK u29x2_sub_noborrow
        { 54 } OP_PICK { 56 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₆⋅B₀+A₀⋅B₆)₂₈…₀ (A₆⋅B₀+A₀⋅B₆)₅₈…₂₉
        // A₃₊₂⋅B₃₊₂ - A₃⋅B₃ - A₂⋅B₂  <=>  A₃⋅B₂ + A₂⋅B₃
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[3] + u29x9_constant[2]) }
        { 62 } OP_PICK { 64 } OP_PICK u29x2_sub_noborrow
        { 60 } OP_PICK { 62 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₃⋅B₂+A₂⋅B₃)₂₈…₀ (A₃⋅B₂+A₂⋅B₃)₅₈…₂₉
        // A₄₊₁⋅B₄₊₁ - A₄⋅B₄ - A₁⋅B₁  <=>  A₄⋅B₁ + A₁⋅B₄
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[4] + u29x9_constant[1]) }
        { 66 } OP_PICK { 68 } OP_PICK u29x2_sub_noborrow
        { 60 } OP_PICK { 62 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₄⋅B₁+A₁⋅B₄)₂₈…₀ (A₄⋅B₁+A₁⋅B₄)₅₈…₂₉
        // A₅₊₀⋅B₅₊₀ - A₅⋅B₅ - A₀⋅B₀  <=>  A₅⋅B₀ + A₀⋅B₅
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[5] + u29x9_constant[0]) }
        { 70 } OP_PICK { 72 } OP_PICK u29x2_sub_noborrow
        { 60 } OP_PICK { 62 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₅⋅B₀+A₀⋅B₅)₂₈…₀ (A₅⋅B₀+A₀⋅B₅)₅₈…₂₉
        // A₃₊₁⋅B₃₊₁ - A₃⋅B₃ - A₁⋅B₁  <=>  A₃⋅B₁ + A₁⋅B₃
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[3] + u29x9_constant[1]) }
        { 68 } OP_PICK { 70 } OP_PICK u29x2_sub_noborrow
        { 64 } OP_PICK { 66 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₃⋅B₁+A₁⋅B₃)₂₈…₀ (A₃⋅B₁+A₁⋅B₃)₅₈…₂₉
        // A₄₊₀⋅B₄₊₀ - A₄⋅B₄ - A₀⋅B₀  <=>  A₄⋅B₀ + A₀⋅B₄
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[4] + u29x9_constant[0]) }
        { 72 } OP_PICK { 74 } OP_PICK u29x2_sub_noborrow
        { 64 } OP_PICK { 66 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₄⋅B₀+A₀⋅B₄)₂₈…₀ (A₄⋅B₀+A₀⋅B₄)₅₈…₂₉
        // A₂₊₁⋅B₂₊₁ - A₂⋅B₂ - A₁⋅B₁  <=>  A₂⋅B₁ + A₁⋅B₂
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[2] + u29x9_constant[1]) }
        { 70 } OP_PICK { 72 } OP_PICK u29x2_sub_noborrow
        { 68 } OP_PICK { 70 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₂⋅B₁+A₁⋅B₂)₂₈…₀ (A₂⋅B₁+A₁⋅B₂)₅₈…₂₉
        // A₃₊₀⋅B₃₊₀ - A₃⋅B₃ - A₀⋅B₀  <=>  A₃⋅B₀ + A₀⋅B₃
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[3] + u29x9_constant[0]) }
        { 74 } OP_PICK { 76 } OP_PICK u29x2_sub_noborrow
        { 68 } OP_PICK { 70 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₃⋅B₀+A₀⋅B₃)₂₈…₀ (A₃⋅B₀+A₀⋅B₃)₅₈…₂₉
        // A₂₊₀⋅B₂₊₀ - A₂⋅B₂ - A₀⋅B₀  <=>  A₂⋅B₀ + A₀⋅B₂
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[2] + u29x9_constant[0]) }
        { 74 } OP_PICK { 76 } OP_PICK u29x2_sub_noborrow
        { 70 } OP_PICK { 72 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₂⋅B₀+A₀⋅B₂)₂₈…₀ (A₂⋅B₀+A₀⋅B₂)₅₈…₂₉
        // A₁₊₀⋅B₁₊₀ - A₁⋅B₁ - A₀⋅B₀  <=>  A₁⋅B₀ + A₀⋅B₁
        OP_FROMALTSTACK { u30_mul_to_u29_carry_31_imm(u29x9_constant[1] + u29x9_constant[0]) }
        { 74 } OP_PICK { 76 } OP_PICK u29x2_sub_noborrow
        { 72 } OP_PICK { 74 } OP_PICK u29x2_sub_noborrow
        // ⋯ (A₁⋅B₀+A₀⋅B₁)₂₈…₀ (A₁⋅B₀+A₀⋅B₁)₅₈…₂₉
