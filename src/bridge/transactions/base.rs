...
pub const MIN_RELAY_FEE_ASSERT_COMMIT1: u64 = relay_fee(50000);
pub const MIN_RELAY_FEE_ASSERT_COMMIT2: u64 = relay_fee(50000);
pub const MIN_RELAY_FEE_ASSERT_FINAL: u64 = relay_fee(50000);
