...
pub struct AssertCommit4Transaction {
...
impl PreSignedTransaction for AssertCommit4Transaction {
...
impl AssertCommit4Transaction {
    ...
    pub fn new_for_validation(
        ...
        AssertCommit4Transaction {
            ...
            prev_scripts: vec![connector_e_4.generate_script()],
        }
    }
...
impl BaseTransaction for AssertCommit4Transaction {
