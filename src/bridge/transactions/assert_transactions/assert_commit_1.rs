...
use super::super::{
    super::{
        connectors::{base::*, connector_e_1::ConnectorE1},
...
impl AssertCommit1Transaction {
    pub fn new(context: &OperatorContext, connector_e_1: &ConnectorE1, input_0: Input) -> Self {
        let mut this = Self::new_for_validation(connector_e_1, input_0);
    ...
    pub fn new_for_validation(connector_e_1: &ConnectorE1, input_0: Input) -> Self {
        let _input_0 = connector_e_1.generate_tx_in(&input_0);

        let total_output_amount = input_0.amount - Amount::from_sat(FEE_AMOUNT);

        let _output_0 = TxOut {
            value: total_output_amount,
            script_pubkey: connector_e_1.generate_address().script_pubkey(),
        };
        ...
        AssertCommit1Transaction {
            ...
            prev_scripts: vec![connector_e_1.generate_script()],
        }
    }
