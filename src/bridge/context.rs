...
pub struct BridgeContext {
    ...
    pub n_of_n_private_key: Option<PrivateKey>,
    ...
    pub depositor_private_key: Option<PrivateKey>,
    ...
    pub withdrawer_private_key: Option<PrivateKey>,
...
impl BridgeContext {
    ...
    pub fn initialize_operator(&mut self, secret: &str) {
        ...
        self.operator_private_key = Some(PrivateKey::new(self.operator_keypair.unwrap().secret_key(), Network::Testnet));
        self.operator_public_key = Some(PublicKey::from_private_key(&self.secp, &self.operator_private_key.unwrap()));
    ...
    pub fn initialize_n_of_n(&mut self, secret: &str) {
        ...
        self.n_of_n_private_key = Some(PrivateKey::new(self.n_of_n_keypair.unwrap().secret_key(), Network::Testnet));
        self.n_of_n_public_key = Some(PublicKey::from_private_key(&self.secp, &self.n_of_n_private_key.unwrap()));
    ...
    pub fn initialize_depositor(&mut self, secret: &str) {
        ...
        self.depositor_private_key = Some(PrivateKey::new(self.depositor_keypair.unwrap().secret_key(), Network::Testnet));
        self.depositor_public_key = Some(PublicKey::from_private_key(&self.secp, &self.depositor_private_key.unwrap()));
    ...
    pub fn initialize_withdrawer(&mut self, secret: &str) {
        ...
        self.withdrawer_private_key = Some(PrivateKey::new(self.withdrawer_keypair.unwrap().secret_key(), Network::Testnet));
        self.withdrawer_public_key = Some(PublicKey::from_private_key(&self.secp, &self.withdrawer_private_key.unwrap()));
