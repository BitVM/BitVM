...
pub fn bit_state(actor: &mut dyn Actor, identifier: &str, index: Option<u32>) -> ScriptBuf {
    script! {
...
pub fn bit_state_commit(actor: &mut dyn Actor, identifier: &str, index: Option<u32>) -> ScriptBuf {
    script! {
        // Validate size of the preimage
        OP_SIZE { PREIMAGE_SIZE } OP_EQUALVERIFY
...
pub fn bit_state_justice(actor: &mut dyn Actor, identifier: &str, index: Option<u32>) -> ScriptBuf {
    script! {
        OP_RIPEMD160
        { actor.hashlock(identifier, index, 0) }  // hash0
        OP_EQUALVERIFY
...
pub fn u2_state(actor: &mut dyn Actor, identifier: &str, index: Option<u32>) -> ScriptBuf {
    script! {
        // Validate size of the preimage
        OP_SIZE { PREIMAGE_SIZE } OP_EQUALVERIFY
...
pub fn u2_state_commit(actor: &mut dyn Actor, identifier: &str, index: Option<u32>) -> ScriptBuf {
    script! {
        // Validate size of the preimage
        OP_SIZE { PREIMAGE_SIZE } OP_EQUALVERIFY
...
pub fn u8_state(actor: &mut dyn Actor, identifier: &str) -> ScriptBuf {
    script! {
        {unroll(4, |i| script!{
...
pub fn u8_state_commit(actor: &mut dyn Actor, identifier: &str) -> ScriptBuf {
    script! {
...
pub fn u8_state_unlock(actor: &mut dyn Actor, identifier: &str, value: u8) -> ScriptBuf {
...
pub fn u32_state(actor: &mut dyn Actor, identifier: &str) -> ScriptBuf {
    script! {
...
pub fn u32_state_commit(actor: &mut dyn Actor, identifier: &str) -> ScriptBuf {
    script! {
...
pub fn u32_state_unlock(actor: &mut dyn Actor, identifier: &str, value: u32) -> ScriptBuf {
    script! {
        { unroll(4, |i| u8_state_unlock(actor, &u32_id(identifier, 3 - i), get_u8(value, 3 - i))) }
    }
}

pub fn u2_state_bit0(actor: &mut dyn Actor, identifier: &str, index: Option<u32>) -> ScriptBuf {
    script! {
        OP_RIPEMD160
        OP_DUP
        { actor.hashlock(identifier, index, 3) }// hash3
...
pub fn u2_state_bit1(actor: &mut dyn Actor, identifier: &str, index: Option<u32>) -> ScriptBuf {
    script! {
        OP_RIPEMD160
        OP_DUP
        { actor.hashlock(identifier, index, 3) } // hash3
...
pub fn u8_state_bit(actor: &mut dyn Actor, identifier: &str, bit_index: u8) -> ScriptBuf {
    assert!(bit_index < 8);
...
pub fn u32_state_bit(actor: &mut dyn Actor, identifier: &str, bit_index: u8) -> ScriptBuf {
    assert!(bit_index < 32);
