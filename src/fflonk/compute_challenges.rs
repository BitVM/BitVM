...
mod test {
    ...
    fn test_compute_challenges_beta() {
        ...
        let script = script! {
            // push C0
            { Fq::push_dec_montgomery("303039279492065453055049758769758984569666029850327527958551993331680103359")}
            { Fq::push_dec_montgomery("15061669176783843627135305167141360334623983780813847469326507992811672859575")}
            // push the public input
            { Fq::push_dec_montgomery("246513590391103489634602289097178521809") }
            { Fq::push_dec_montgomery("138371009144214353742010089705444713455") }
            // push C1
    ...
    fn test_compute_challenges_alpha() {
        ...
        let script = script! {
            // push xi seed
            { Fr::push_dec_montgomery("12675309311304482509247823029963782393309524866265275290730041635615278736000") }
            ...
            {blake3_script.clone()}
            { Fr::from_hash() }
            { Fr::push_dec_montgomery("13196272401875304388921830696024531900252495617961467853893732289110815791950") }
            { Fr::equal(1, 0) }
        };
    ...
    fn test_compute_challenges_xin() {
        let script = script! {
            ...
            { Fr::copy(0) }
            // push constant w8_1
            { Fr::push_dec_montgomery("19540430494807482326159819597004422086093766032135589407132600596362845576832") }
            { Fr::mul() }
            ...
            { Fr::copy(0) }
            // push constant w8_2
            { Fr::push_dec_montgomery("21888242871839275217838484774961031246007050428528088939761107053157389710902") }
            { Fr::mul() }
            ...
            { Fr::copy(0) }
            // push constant w8_3
            { Fr::push_dec_montgomery("13274704216607947843011480449124596415239537050559949017414504948711435969894") }
            { Fr::mul() }
            ...
            { Fr::copy(0) }
            // push constant w8_4
            { Fr::push_dec_montgomery("21888242871839275222246405745257275088548364400416034343698204186575808495616") }
            { Fr::mul() }
            ...
            { Fr::copy(0) }
            // push constant w8_5
            { Fr::push_dec_montgomery("2347812377031792896086586148252853002454598368280444936565603590212962918785") }
            { Fr::mul() }
            ...
            { Fr::copy(0) }
            // push constant w8_6
            { Fr::push_dec_montgomery("4407920970296243842541313971887945403937097133418418784715") }
            { Fr::mul() }
            ...
            { Fr::copy(0) }
            // push constant w8_7
            { Fr::push_dec_montgomery("8613538655231327379234925296132678673308827349856085326283699237864372525723") }
            { Fr::mul() }
            ...
            { Fr::copy(0) }
            // push constant w3
            { Fr::push_dec_montgomery("21888242871839275217838484774961031246154997185409878258781734729429964517155") }
            { Fr::mul() }
            ...
            { Fr::copy(0) }
            // push constant w3_2
            { Fr::push_dec_montgomery("4407920970296243842393367215006156084916469457145843978461") }
            { Fr::mul() }
            ...
            { Fr::push_dec_montgomery("19699792133865984655632994927951174943026102279822605383822362801478354085676") }
            { Fr::mul() }
            ...
            // xin
            { Fr::copy(0) }
            { Fr::push_dec_montgomery("9539499652122301619680560867461437153480631573357135330838514610439758374056") }
            { Fr::equalverify(1, 0) }
