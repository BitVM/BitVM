...
mod test {
    ...
    fn test_compute_r2() {
        ...
        let script = script! {
            ...
            { Fr::push_u32_le_montgomery(&BigUint::from(zh_inv).to_u32_digits()) }
            ...
            { Fr::push_u32_le_montgomery(&BigUint::from(lis2_1_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis2_2_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis2_3_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis2_4_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis2_5_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis2_6_inv).to_u32_digits()) }
