...
mod test {
    ...
    fn test_compute_r0() {
        ...
        let script = script! {
            ...
            // push LiS0Inv 1-8
            { Fr::push_u32_le_montgomery(&BigUint::from(lis0_1_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis0_2_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis0_3_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis0_4_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis0_5_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis0_6_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis0_7_inv).to_u32_digits()) }
            { Fr::push_u32_le_montgomery(&BigUint::from(lis0_8_inv).to_u32_digits()) }
