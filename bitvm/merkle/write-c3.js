...
export class MerkleHashC3NodeLeftLeaf extends Leaf {
...
export class MerkleHashC3NodeRightLeaf extends Leaf {
...
export class MerkleHashC3RootLeftLeaf extends Leaf {
...
export class MerkleHashC3RootRightLeaf extends Leaf {
...
export class MerkleHashC3LeafLeftLeaf extends Leaf {
...
export class MerkleHashC3LeafRightLeaf extends Leaf {
...
export class MerkleHashC_3 extends Transaction {
    static ACTOR = PAUL
    static taproot(params) {
        const {vicky, paul} = params;
        return [
            ...loop(PATH_LEN - 2, merkleIndexC => [MerkleHashC3NodeLeftLeaf, vicky, paul, merkleIndexC + 1]),
            ...loop(PATH_LEN - 2, merkleIndexC => [MerkleHashC3NodeRightLeaf, vicky, paul, merkleIndexC + 1]),
            ...loop(LOG_TRACE_LEN, traceIndex => [MerkleHashC3RootLeftLeaf, vicky, paul, traceIndex]),
            ...loop(LOG_TRACE_LEN, traceIndex => [MerkleHashC3RootRightLeaf, vicky, paul, traceIndex]),
            [MerkleHashC3LeafLeftLeaf, vicky, paul],
            [MerkleHashC3LeafRightLeaf, vicky, paul],
        ]
    }
}


export class MerkleEquivocationC_3 extends EndTransaction {
    static ACTOR = VICKY
