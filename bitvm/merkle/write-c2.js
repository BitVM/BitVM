...
export class MerkleHashC2NodeLeftLeaf extends Leaf {
...
export class MerkleHashC2NodeRightLeaf extends Leaf {
...
export class MerkleHashC2RootLeftLeaf extends Leaf {
...
export class MerkleHashC2RootRightLeaf extends Leaf {
...
export class MerkleHashC2LeafLeftLeaf extends Leaf {
...
export class MerkleHashC2LeafRightLeaf extends Leaf {
...
export class MerkleHashC_2 extends Transaction {
    static ACTOR = PAUL
    static taproot(params) {
        const {vicky, paul} = params;
        return [
            ...loop(PATH_LEN - 2, merkleIndexC => [MerkleHashC2NodeLeftLeaf, vicky, paul, merkleIndexC + 1]),
            ...loop(PATH_LEN - 2, merkleIndexC => [MerkleHashC2NodeRightLeaf, vicky, paul, merkleIndexC + 1]),
            ...loop(LOG_TRACE_LEN, traceIndex => [MerkleHashC2RootLeftLeaf, vicky, paul, traceIndex]),
            ...loop(LOG_TRACE_LEN, traceIndex => [MerkleHashC2RootRightLeaf, vicky, paul, traceIndex]),
            [MerkleHashC2LeafLeftLeaf, vicky, paul],
            [MerkleHashC2LeafRightLeaf, vicky, paul],
        ]
    }
}


export class MerkleEquivocationC_2 extends EndTransaction {
    static ACTOR = VICKY
