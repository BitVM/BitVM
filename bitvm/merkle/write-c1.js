...
export class MerkleHashC1NodeLeftLeaf extends Leaf {
...
export class MerkleHashC1NodeRightLeaf extends Leaf {
...
export class MerkleHashC1RootLeftLeaf extends Leaf {
...
export class MerkleHashC1RootRightLeaf extends Leaf {
...
export class MerkleHashC1LeafLeftLeaf extends Leaf {
...
export class MerkleHashC1LeafRightLeaf extends Leaf {
...
export class MerkleHashC_1 extends Transaction {
    static ACTOR = PAUL
    static taproot(params) {
        const {vicky, paul} = params;
        return [
            ...loop(PATH_LEN - 2, merkleIndexC => [MerkleHashC1NodeLeftLeaf, vicky, paul, merkleIndexC + 1]),
            ...loop(PATH_LEN - 2, merkleIndexC => [MerkleHashC1NodeRightLeaf, vicky, paul, merkleIndexC + 1]),
            ...loop(LOG_TRACE_LEN, traceIndex => [MerkleHashC1RootLeftLeaf, vicky, paul, traceIndex]),
            ...loop(LOG_TRACE_LEN, traceIndex => [MerkleHashC1RootRightLeaf, vicky, paul, traceIndex]),
            [MerkleHashC1LeafLeftLeaf, vicky, paul],
            [MerkleHashC1LeafRightLeaf, vicky, paul],
        ]
    }
}


export class MerkleEquivocationC_1 extends EndTransaction {
    static ACTOR = VICKY
