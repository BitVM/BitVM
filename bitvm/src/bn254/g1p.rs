...
mod test {
    ...
    fn test_batched_scalar_mul2() {
        ...
        for _ in 0..1 {
            let scalar0 = ark_bn254::Fr::rand(&mut prng);
            println!("scalar0 => {}", scalar0);
            let point0 = ark_bn254::G1Projective::rand(&mut prng);
            let scalar1 = ark_bn254::Fr::rand(&mut prng);
