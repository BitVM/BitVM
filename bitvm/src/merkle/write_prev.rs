...
// fn MerkleChallengeCPrevLeaf(model: BitVmModel) -> BitVmLeaf{
...
// fn MerkleResponseCPrevLeaf(model: BitVmModel) -> BitVmLeaf{
...
// fn MerkleHashCPrevNodeLeftLeaf(model: BitVmModel) -> BitVmLeaf{
...
// fn MerkleHashCPrevNodeRightLeaf(model: BitVmModel) -> BitVmLeaf{
...
// fn MerkleHashCPrevRootLeftLeaf(model: BitVmModel) -> BitVmLeaf{
...
// fn MerkleHashCPrevRootRightLeaf(model: BitVmModel) -> BitVmLeaf{
...
// fn MerkleHashCPrevSiblingLeftLeaf(model: BitVmModel) -> BitVmLeaf{
...
// fn MerkleHashCPrevSiblingRightLeaf(model: BitVmModel) -> BitVmLeaf{
