...
pub fn COMMIT_INSTRUCTION_ADD_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
...
fn COMMIT_INSTRUCTION_ADD_IMMEDIATE_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_SUB_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_SUB_IMMEDIATE_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_LOAD_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_STORE_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_AND_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_AND_IMMEDIATE_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_OR_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_OR_IMMEDIATE_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_XOR_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_XOR_IMMEDIATE_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_JMPLEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_BEQLEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
...
fn COMMIT_INSTRUCTION_BNELEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                // Ensure the instruction_type is {ASM_BEQ}
...
fn COMMIT_INSTRUCTION_RSHIFT1_LEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_SLTULEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
fn COMMIT_INSTRUCTION_SLTLEAF() -> BitVmLeaf {
    BitVmLeaf {
        lock: |model| {
            script! {
                {model.paul.push().instruction_type()}
...
pub fn commit_instruction() -> Vec<BitVmLeaf> {
    vec![
