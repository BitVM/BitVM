...
pub fn commit_instruction() -> Vec<BitVmLeaf> {
    vec![
        ...
        COMMIT_INSTRUCTION_AND_LEAF,
        COMMIT_INSTRUCTION_BEQLEAF,
        COMMIT_INSTRUCTION_BNELEAF,
        COMMIT_INSTRUCTION_JMPLEAF,
        COMMIT_INSTRUCTION_LOAD_LEAF,
        COMMIT_INSTRUCTION_OR_IMMEDIATE_LEAF,
        COMMIT_INSTRUCTION_OR_LEAF,
        COMMIT_INSTRUCTION_RSHIFT1_LEAF,
        COMMIT_INSTRUCTION_SLTULEAF,
        COMMIT_INSTRUCTION_SLT_LEAF,
        COMMIT_INSTRUCTION_STORE_LEAF,
        COMMIT_INSTRUCTION_SUB_IMMEDIATE_LEAF,
        COMMIT_INSTRUCTION_SUB_LEAF,
        COMMIT_INSTRUCTION_XOR_IMMEDIATE_LEAF,
        COMMIT_INSTRUCTION_XOR_LEAF
    ]
}
