...
import { u8_state, u8_state_unlock, u32_state, u32_state_unlock, u2_state_commit, u2_state_commit_unlock, u8_state_commit_unlock, u8_state_commit, u32_state_commit_unlock, u32_state_commit } from '../opcodes/u32/u32_state.js'
import { u160_state, u160_state_unlock, u160_state_commit_unlock, u160_state_commit, u160_equalverify } from '../opcodes/u160/u160_std.js'
...
export function preprocessJS(text) {
    ...
    if (Array.isArray(code)) {
        code = optimize(code.flat(30)).join(' ')
    }
